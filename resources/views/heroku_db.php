...
<body>
    ...
    <?php
        ...
        $tables=['users','password_resets','settings','files','countries','cities','states','departments','trade_marks','manufacturers','shippings','malls','colors','sizes','weights','products','other_datas','mall_products','jobs','admins'];
