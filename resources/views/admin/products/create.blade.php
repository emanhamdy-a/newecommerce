...
<link href="{{ aurl('/design\Adminlte\select2/select2.min.css') }}" rel="stylesheet" />
@push('js')
<script src="{{ aurl('/design\Adminlte\select2/select2.min.js') }}"></script>
...
<div class="box">
  ...
  <div class="box-body">
    ...
    <a href="#" class="btn btn-danger delete"  data-toggle="modal" data-target="#del_admin{{1}}">{{ trans('admin.delete') }} <i class="fa fa-trash"></i></a>
    <hr />
    ...
    <div class="tab-content">
      ...
      <div id="product_setting"class="tab-pane fade">product_setting</div>
      <div id="product_media"  class="tab-pane fade">product_media</div>
      <div id="product_size_weight" class="tab-pane fade">product_size_weight</div>
      <div id="other_data"     class="tab-pane fade">other_data</div>
      <div id="related_product"class="tab-pane fade">related_product</div>
    </div>
  <hr/>
...
<!-- Modal -->
<div id="del_admin{{1}}" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>{{ trans('admin.delete_this',['name'=> '1']) }}</h4>
      </div>
