...
<div class="box">
  ...
  <!-- /.box-header -->
  <div class="box-body">
    {!! Form::open(['url'=>aurl('merchants'),'files'=>true]) !!}
    ...
    <input type="hidden" value="{{ $lng }}" id="lng" name="lng">
     ...
     <div class="form-group">
        {!! Form::label('contact_name',trans('admin.contact_m_name')) !!}
        {!! Form::text('contact_name',old('contac_name'),['class'=>'form-control']) !!}
     </div>
     ...
     <div class="form-group">
        {!! Form::label('icon',trans('admin.merchant_icon')) !!}
