...
<style type="text/css">
 /* .jstree li > a > .jstree-icon {  width:25px !important; } */
</style>
<!-- Modal -->
...
// }).on('select_node.jstree', function (e, data) { data.instance.set_icon(data.node, "glyphicon glyphicon-heart"); });
// }).on('deselect_node.jstree', function (e, data) { data.instance.set_icon(data.node, "glyphicon glyphicon-heart"); });
});
 ...
 $('#jstree').on('changed.jstree',function(e,data){
    ...
    if(r.join(', ') != '')
    {
      ...
      // $('#edt').val('{{ aurl('departments') }}/'+r.join(', ')+'/edit');
    }else{
