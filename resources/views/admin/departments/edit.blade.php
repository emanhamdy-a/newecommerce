...
$(document).ready(function(){
  ...
  $('#jstree').jstree({
    "core" : {
      'data' : {!! get_dep($department->parent,$department->id) !!},
      "themes" : {
        "variant" : "large"
      }
    },
...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="box-body">
          ...
          <a style='margin-bottom:25px;' class="btn btn-info mn_dp showbtn_control" ><i class="fa fa-tags"></i> {{ trans('admin.make_it_main') }}</a>
          <div id="jstree"></div>
        ...
        <div class="form-group">
            ...
            @if(!empty($department->icon) and Storage::has('public/' . $department->icon))
