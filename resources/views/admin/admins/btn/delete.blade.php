...
@if(admin()->user()->id==$id)
<button id="del{{$id}}" type="button" class="btn btn-danger" data-toggle="modal" data-target="#del_admin{{ $id }}"><i class="fa fa-trash"></i></button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3 class="modal-title text-center">{{ trans('admin.you') }}</h3>
      </div>
